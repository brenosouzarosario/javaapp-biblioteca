...
public class Frm_SaidaDados extends javax.swing.JDialog {
    ...
    public Frm_SaidaDados(java.awt.Frame parent, boolean modal,int multa) {
        super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(null);
        this.txtNome.setText(Cls_Usuario.getNome());
        this.txtMulta.setText(String.valueOf(multa));
    }
    ...
    private void initComponents() {
        ...
        btnFechar.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
        btnFechar.setText("Fechar");

        txtNome.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
        txtNome.setEnabled(false);

        txtMulta.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
        txtMulta.setEnabled(false);

        jLabel1.setFont(new java.awt.Font("Arial", 0, 36)); // NOI18N
        jLabel1.setText("Biblioteca - Saída");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Frm_SaidaDados dialog = new Frm_SaidaDados(new javax.swing.JFrame(), true,0);
